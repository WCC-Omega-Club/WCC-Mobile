...
namespace WCCMobile
{
    public class DiskCache
    {
        ...
        private void InitializeWithJournal()
        {
        ...
        private bool EnsureHeader(StreamReader reader)
        {
        ...
        private JournalOp ParseOp(string line)
        {
            return (JournalOp)line[0];
        }

        private void ParseEntry(string line, out string key)
        {
            key = line.Substring(2);
        }

        private void ParseEntry(string line, out string key, out DateTime origin, out TimeSpan duration)
        {
            key = null;
