...
namespace WCCMobile.Activities
{
    ...
    public class ContactsActvity : AppCompatActivity
    {
        ...
        /// <summary>
        /// Convenience field to act as an empty_email_guard
        /// </summary>
        ...
        /// <summary>
        /// Launches an alert with two buttons.
        /// Button 1 - Phone Contact
        /// Button 2 - Email Contact
        /// </summary>
        /// <param name="PhoneKey">The phone key.</param>
